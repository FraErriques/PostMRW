...
public:
    ClassicalContinuousGenerator( unsigned int seed);// : currentSeed(seed), generatorSUP(RAND_MAX);
    ...
    ClassicalContinuousGenerator();// : currentSeed( time(NULL)), generatorSUP(RAND_MAX);
