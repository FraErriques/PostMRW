...
//    else
//    {
//        Process::LogWrappers::SectionOpen("Entity::Integration::trapezi:inner core==rettangoli", 0);
//    }
//    //
...
//                  )
//{
//    Process::LogWrappers::SectionOpen("Entity::Integration::correttivoAlContorno()", 0);
//    //
//    long double dx = (sup-inf) / cardPartiz;
...
//                  )
//{
//    Process::LogWrappers::SectionOpen("Entity::Integration::trapezi()", 0);
//    //
