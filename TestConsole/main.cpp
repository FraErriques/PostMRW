...
int main()
{
    ...
    //const char * primeDefaultFile = prime.createOrAppend("./PrimeConfig.txt", "primeDefaultFile");


    //Common::dbCall::cantiere_sede_INSERT_SINGLE();
    //int res = Common::DbConnectionService::dbName_tableName_paramsList_INSERT_SINGLE("cantiere","`usp_cantiere_Primes_INSERT`","31");
    //Common::DbConnectionService::do_usp_LOAD(); crashes...sadly.
