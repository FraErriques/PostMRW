...
class Primes
{
    ...
    public:
       ...
       Primes   ( const size_t Prows, const size_t Pcols, bool randomized, const char * where=NULL );
       /// copying methoda
       // Copy Constructor
       ...
       unsigned getActualOrdinal();
       unsigned getActualPrime();
       bool getCanOperateStatus();
